        ...
        <div class="container mt-4">
            ...
            <div class="mt-4">
                <ul class="nav nav-tabs" id="bladeTabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="add-author-tab" data-bs-toggle="tab" data-bs-target="#add-author"
                            type="button" role="tab" aria-controls="add-author"
                            aria-selected="false">author</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="add-translator-tab" data-bs-toggle="tab"
                            data-bs-target="#add-translator" type="button" role="tab"
                            aria-controls="add-translator" aria-selected="false">translator</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="add-publisher-tab" data-bs-toggle="tab"
                            data-bs-target="#add-publisher" type="button" role="tab" aria-controls="add-publisher"
                ...
                <div class="tab-content mt-4" id="bladeTabsContent">
                    ...
                    <div class="tab-pane fade" id="add-translator" role="tabpanel"
                        aria-labelledby="add-translator-tab">
                        @include('admin.add-translator')
                    </div>
                    <div class="tab-pane fade" id="add-publisher" role="tabpanel"
                        aria-labelledby="add-publisher-tab">
