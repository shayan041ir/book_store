...
<div class="container mt-4">
    <button class="btn btn-outline-secondary mb-4" onclick="location.href='{{ route('home.page') }}';">بازگشت به صفحه
        اصلی</button>

    <div class="row">
        <div class="col-md-6">
            <div class="image-container">
                <img src="{{ asset('storage/' . $book->image) }}" alt="{{ $book->name }}" class="img-fluid book-image">
            </div>
        </div>
        <div class="col-md-6">
