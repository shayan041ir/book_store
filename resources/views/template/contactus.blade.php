    ...
    <section>
        <div class="container mt-5">
            <p>
                ...
                <br>
                تلفن تماس و فکس: 62999935 - 021 (پاسخگویی در روز های کاری شنبه تا چهارشنبه از ساعت ۹ تا ۱۸ - پنجشنبه از
                ساعت ۹ تا ۱۶ می‌باشد)

                <br>
                توجه داشته باشید که 10008727 - 10001631 - 20003908 شماره‌ های است که کتاب نگار از طریق آن برای کاربران
                ...
                <br>
                همچنین شماره های اعلام شده سامانه ارسال پیامک است که وضعیت پردازش سفارش یا رویدادها، خدمات و سرویس‌های
                ویژه کتاب نگار را به اطلاع کاربران می‌رساند و روشن است که امکان دریافت پیام‌های شما از طریق این شماره
                وجود ندارد. "
                ...
                <br>
                مشتری گرامی برای پیگیری یا سوال درباره سفارش بهتر است از فرم زیر استفاده کنید. اما اگر تمایل به ارسال
